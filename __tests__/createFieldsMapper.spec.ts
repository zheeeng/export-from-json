import {
  ...
  fieldsObj1, testTableItemsWithFieldsObj1,
...
describe('_createFieldsMapper', () => {
  ...
  it('mapper omit fields correctly 2', () => {
    const fieldsMapper = _createFieldsMapper(fieldsObj1)

    expect(fieldsMapper(testTableItems)).toEqual(testTableItemsWithFieldsObj1)
  })
