...
function exportFromJSON(_a) {
    ...
    switch (exportType) {
        ...
        case 'csv': {
            ...
            var BOM = '\ufeff';
            var CSVData = createCSVData(safeData, beforeTableEncode, separator);
